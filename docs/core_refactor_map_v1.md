...
- [ ] تحديث نهائي للوثائق
- [ ] استكمال أدلة الإغلاق الرسمية لـ R4/R12 (مع بقاء الحالة الحوكمية مفتوحة حتى المصادقة)
...
3. **Semantic Kernel** (14 ملفًا) — Transitional (وليس Extension نهائيًا في هذه الدورة)

**المتبقي:** استكمال أدلة الإغلاق الرسمية لـ R4/R12 وتثبيت متطلبات الحوكمة للـ `r4-r12-gate` كبوابة مطلوبة ومحددة النطاق.
